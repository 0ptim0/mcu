...
set(LINKER_SCRIPT       ${CMAKE_CURRENT_SOURCE_DIR}/mcu/stm32f1/core/${MCU_MODEL}.ld)

set(MCU_FLAGS "-mcpu=cortex-m3 -mlittle-endian -mfloat-abi=soft -mthumb -mno-unaligned-access")
...
set(CMAKE_C_FLAGS_DEBUG "-O0 -g0 ${COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g0 ${COMMON_FLAGS}")
